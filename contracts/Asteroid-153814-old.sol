...
import "./MineEmpireDrill-old.sol";
import "@openzeppelin/contracts/token/ERC721/IERC721Receiver.sol";
import "@openzeppelin/contracts/token/ERC20/IERC20.sol";
import "@openzeppelin/contracts/token/ERC20/presets/ERC20PresetMinterPauser.sol";

contract Asteroid153814Old {
    MineEmpireDrillOld public drill;
    ...
    struct Stake {
        MineEmpireDrillOld.Drill drill;
        uint timestamp;
    }
    ...
    constructor(ERC20PresetMinterPauser inputResource, ERC20PresetMinterPauser outputResource, MineEmpireDrillOld _drill) {
        owner = msg.sender;
        baseProduction = 1e16;
        capacityPerUnit = 100;
